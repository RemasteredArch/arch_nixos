...
in
{
    ...
    home.packages =
        ...
        [
            ...
            # Provides a `batman` command, which is like `man` but syntax highlighted with colors.
            bat-extras.batman
    ...
    home.file.".config/wezterm" = lib.mkIf cfg.trackedWezTermConfig { source = wezterm-config; };
    ...
    # Taken from <https://github.com/catppuccin/btop>, licensed under the MIT License, found at:
    #
    ...
    programs.firefox = lib.mkIf cfg.desktop {
        enable = true;
        languagePacks = [ "en-US" ];
        # TO-DO: XDG Base Directory compat.
        ...
        policies = {
            ...
            FirefoxSuggest = {
                # Also disables other forms of Firefox Suggest.
